...
The following example clones the "[CTS-Client](https://github.com/Infineon/mtb-example-psoc-edge-btstack-cts-client)" application with the desired name "CTsClient" configured for the *KIT_PSE84_EVAL_EPC2* BSP into the specified working directory, *C:/mtb_projects*:

   ```
   project-creator-cli --board-id KIT_PSE84_EVAL_EPC2 --app-id mtb-example-psoc-edge-btstack-cts-client --user-app-name CTsClient --target-dir "C:/mtb_projects"
   ```
