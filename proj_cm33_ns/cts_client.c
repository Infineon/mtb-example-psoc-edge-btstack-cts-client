 ...
 *******************************************************************************/
 ...
 static void ble_app_init(void)
 {
     ...
     wiced_bt_ble_set_raw_scan_response_data (SCAN_RESPONSE_NO_OF_ELEMENTS,
 ...
 void button_task(void *pvParameters)
 {
     ...
     for(;;)
     {
         ...
         {
             if((cts_discovery_data.cts_service_found == true) && (bt_connection_id != CONST_ZERO))
             {
 ...
 ble_app_connect_handler(wiced_bt_gatt_connection_status_t *p_conn_status)
 {
     ...
     if ( NULL != p_conn_status )
     {
         if ( p_conn_status->connected )
         {
             ...
             service_discovery_setup.s_handle = START_HANDLE;
             service_discovery_setup.e_handle = END_HANDLE;
